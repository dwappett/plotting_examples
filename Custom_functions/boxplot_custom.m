...
for D=1:length(Data)
    ...
    for C=1:nC
        ...
        if direction==1 %Vertical case
            ...
            %Draw the boxplot
            H(D)=fill([xl,xr,xr,xl],[Q25 Q25 Q75 Q75],color,'EdgeColor',linecolor,'LineWidth',2,'LineStyle','-','marker','none');
            if top>Q75 %Case where max(x) > Q75
                line([xc xc],[Q75 top],'Color',linecolor,'LineWidth',2,'LineStyle','-','marker','none')
                line([xl,xr],[top top],'Color',linecolor,'LineWidth',2,'LineStyle','-','marker','none')
            end
            if bottom<Q25 %Case where min(x) < Q25
                line([xc xc],[Q25 bottom],'Color',linecolor,'LineWidth',2,'LineStyle','-','marker','none')
                line([xl,xr],[bottom bottom],'Color',linecolor,'LineWidth',2,'LineStyle','-','marker','none')
            end
            line([xl,xr],[Q50 Q50],'Color',linecolor,'LineWidth',2,'LineStyle','-','marker','none')
            
            %Draw the outliers %DW EDITED - originally '+' size 5 and no linewidth
            plot((xc).*ones(length(outliers),1),outliers,'.','color',outliercolor,'MarkerSize',15,'LineWidth',1.5)
        ...
        elseif direction==2 % Horizontal case
            ...
            %Draw the boxplot
            H(D)=fill([Q25 Q25 Q75 Q75],[xl,xr,xr,xl],color,'EdgeColor',linecolor,'LineWidth',2,'LineStyle','-','marker','none');
            if top>Q75
                line([Q75 top],[xc xc],'Color',linecolor,'LineWidth',2,'LineStyle','-','marker','none')
                line([top top],[xl,xr],'Color',linecolor,'LineWidth',2,'LineStyle','-','marker','none')
            end
            if bottom<Q25
                line([Q25 bottom],[xc xc],'Color',linecolor,'LineWidth',2,'LineStyle','-','marker','none')
                line([bottom bottom],[xl,xr],'Color',linecolor,'LineWidth',2,'LineStyle','-','marker','none')
            end
            line([Q50 Q50],[xl,xr],'Color',linecolor,'LineWidth',2,'LineStyle','-','marker','none')
